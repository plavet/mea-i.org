<?php
/*
Template Name Posts: Mea-I Light Green
 */
?>
<!doctype html>
...
<script src="<?php bloginfo('template_directory'); ?>/js/jquery-ui-1.8.21.custom.min.js"></script>
...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
		<div id="box-wrap">
				<span class="close-bg-lightgreen"></span>
				<div class="aside-box">
